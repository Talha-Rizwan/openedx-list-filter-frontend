...
replace all instances of ``openedx-list-filter-frontend`` with the name of
...
This section concerns development of ``openedx-list-filter-frontend`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openTalha-Rizwan/openedx-list-filter-frontend/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openTalha-Rizwan/openedx-list-filter-frontend/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/openedx-list-filter-frontend
...
.. |license-badge| image:: https://img.shields.io/github/license/openTalha-Rizwan/openedx-list-filter-frontend.svg
    :target: https://github.com/openTalha-Rizwan/openedx-list-filter-frontend/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openTalha-Rizwan/openedx-list-filter-frontend/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openTalha-Rizwan/openedx-list-filter-frontend/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openTalha-Rizwan/openedx-list-filter-frontend/coverage.svg?branch=main
    :target: https://codecov.io/github/openTalha-Rizwan/openedx-list-filter-frontend?branch=main
    :alt: Codecov
